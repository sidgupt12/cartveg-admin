...
//       <div className="w-full max-w-4xl flex rounded-2xl shadow-xl overflow-hidden">
//         {/* Left Section: Branding and Image */}
//         <div
//           className="w-1/2 p-8 flex flex-col justify-between text-white"
//           style={{ backgroundColor: 'rgb(170,201,137)' }}
//         >
//           <div>
...
//                 width={150}
//                 height={150}
//                 className="object-contain ml-[-25px] mt-[-10px]" 
//               />
//             </div>
//             <h1 className="mt-12 text-3xl font-semibold">
//               Better Veggies, <br /> Faster Delivery
//             </h1>
//           </div>
//           {/* PNG Image at the Bottom */}
//           <div className="self-center">
//             <Image
//               src="/veggie.png" // Replace with your PNG image path
//               alt="Memory Icon"
//               width={150}
//               height={150}
